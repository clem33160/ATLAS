...
LAYER_SPECS: tuple[LayerSpec, ...] = (
    ...
    LayerSpec("causal", "mémoire causale", ("atlas_memory/src/causal_store.py",), ("atlas_memory/tests/test_memory_deep_integration.py",), ("causal",)),
    ...
    LayerSpec("simulation", "mémoire de simulation", ("atlas_memory/src/simulation_store.py",), ("atlas_memory/tests/test_memory_deep_integration.py",), ("simulation",)),
    LayerSpec("social", "mémoire sociale", ("atlas_memory/src/social_store.py",), ("atlas_memory/tests/test_memory_deep_integration.py",), ("social",)),
